 ...
 */
package com.gpt.tdGptAddon.jalo;
...
import com.gpt.tdGptAddon.constants.TdGptAddonConstants;



/**
 * This is the extension manager of the TdGptAddon extension.
 */
public class TdGptAddonManager extends GeneratedTdGptAddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TdGptAddonManager.class.getName());
	 ...
	 */
	public static TdGptAddonManager getInstance()
	{
		return (TdGptAddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TdGptAddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TdGptAddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TdGptAddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TdGptAddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TdGptAddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
