 ...
 */
package com.gpt.core.constants;

/**
 * Global class for all TdGptCore constants. You can add global constants for your extension into this class.
 */
public final class TdGptCoreConstants extends GeneratedTdGptCoreConstants
{
	public static final String EXTENSIONNAME = "tdGptcore";


	private TdGptCoreConstants()
	{
		//empty
	}
