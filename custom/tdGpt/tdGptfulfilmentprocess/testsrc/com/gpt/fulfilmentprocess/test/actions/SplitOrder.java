 ...
 */
package com.gpt.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TdGptFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TdGptFulfilmentProcessConstants.PARENT_PROCESS);
