...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tdGptstorefront/electronics/en",
						"https://electronics.local:9002/tdGptstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tdGptstorefront/electronics/en",
						"https://electronics.local:9002/tdGptstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tdGptstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tdGptstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tdGptstorefront/electronics/en",
						"https://electronics.local:9002/tdGptstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tdGptstorefront",
						"https://electronics.local:9002/tdGptstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tdGptstorefront",
						"https://electronics.local:9002/tdGptstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tdGptstorefront/electronics/en",
						"https://electronics.local:9002/tdGptstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
