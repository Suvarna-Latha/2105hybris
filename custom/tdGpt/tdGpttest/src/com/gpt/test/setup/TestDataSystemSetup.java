...
import com.gpt.test.constants.TdGptTestConstants;
import com.gpt.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TdGptTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tdGpttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tdGpttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/tdGpttest/import/cstickets.impex");
			...
			importImpexFile(context, "/tdGpttest/import/csquotes.impex");
		}
	}
}
